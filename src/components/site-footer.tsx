  ...
  return (
    <footer className="border-t border-zinc-800 bg-zinc-950">
        ...
        <div className="max-w-sm">
          ...
          <div className="mt-4 flex gap-3">
            <a
              ...
              aria-label="YouTube"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-zinc-800 text-zinc-400 transition-colors hover:border-amber-400 hover:text-amber-400"
            >
      ...
      <div className="border-t border-zinc-800/60 py-4 text-center text-xs text-zinc-500">
        &copy; {new Date().getFullYear()} {site.artistFull}. All rights reserved. <span className="ml-1 text-zinc-500">Crafted by</span>{" "}
          <a
